...
<p>After installing the exchange, complete the KYC (ID and personal info). It may take some time to be approved. Once verified, you just need to follow the steps.</p>
...
<div class="exchange-toggle-container">
  ...
  <div class="exchange-images">
    ...
    <div class="image-set" data-exchange="relai">
      <p>In <b>Relai</b> go to: <b>Buy → Savings plan → Show bank details</b> (labels may vary slightly).</p>
      <div class="phone-images-row">
