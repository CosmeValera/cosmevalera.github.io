  ...
  <div class="exchange-images">
    <div class="image-set" data-exchange="21bitcoin">
      ...
      <ul>
        ...
        <li>The app will now ask you to <b>verify ownership</b></li>
        <!-- <li>Go back to the <b>sign/verify screen to verify</b> the address</li>
...
<p>The exchange is legally required to verify that the wallet address belongs to you. You'll need to sign a message from your wallet to prove ownership.</p>
...
<ul>
  ...
  <li>Select <b>Sign/Verify Message</b></li>
  ...
  <li>Return to the exchange and <b>paste the signature</b> to complete verification</li>
</ul>
