  ...
  <div class="exchange-images">
    <div class="image-set" data-exchange="21bitcoin">
      ...
      <ul>
        ...
        <li>Choose <b>Non-Custodial mode</b> (or <b>Set a balance limit</b>)<sup>*</sup></li>
...
>
> <p><b>** Alternative verification method:</b> 21Bitcoin also offers digital signature verification if 2FA isn't available on your device. Follow the same process shown in the Relai tab (section 3).</p>
<p><b>Transfer Fee Consideration:</b> Each transfer costs 1000 sats (roughly 1€). With non-custodial mode, you pay this fee for every purchase. With balance limits, you can set a higher threshold (like 300-500€) to reduce transfer frequency while maintaining automatic custody.</p>
    </div>
    <div class="image-set" data-exchange="relai">
      <p>In <b>Relai:</b></p>
      <ul>
