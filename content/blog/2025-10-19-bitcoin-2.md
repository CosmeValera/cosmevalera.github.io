...
<p>On your phone, install either <a target="_blank" href="https://play.google.com/store/apps/details?id=fior.digital21app">21Bitcoin</a> or <a target="_blank" href="https://play.google.com/store/apps/details?id=com.relai">Relai</a>. Both work in a very similar way and are designed for buying Bitcoin. In this guide, I will give explanations and screenshots for both apps.</p>

> There are other ways to buy Bitcoin, such as using peer-to-peer exchanges like <a target="_blank" href="https://hodlhodl.com/">HodlHodl</a> which do not require **KYC (Know Your Customer)**. KYC  is the process where you submit your ID and personal information to prove your identity. However, Bitcoin is fundamentally about financial privacy, and KYC exchanges like 21Bitcoin or Relai contradict this philosophy as these apps store the personal information of those who have purchased or sold sats. However, these KYC exchanges are much easier to navigate as beginners, and starting off with one of them is a reasonable tradeoff. As you gain experience, you can explore other options that protect your privacy better.
...
<p>After installing the exchange, complete the KYC (ID and personal info). The approval usually takes a few days.</p>
...
<div class="exchange-toggle-container">
  ...
  <div class="exchange-images">
    ...
    <p>Use this information to set up automatic Bitcoin purchases from your bank account to your chosen exchange app (21Bitcoin or Relai). Start with an amount you're comfortable with, perhaps 100€ per month, and then adjust as you gain experience.</p>
    ...
    <div class="image-set" data-exchange="relai">
      <p>In <b>Relai</b> go to: <b>Buy</b> → Select <b>amount</b> → Select <b>weekly auto-invest or Monthly auto-invest</b> → Select <b>Payment Method</b> → <b>Buy Now</b> → Copy the <b>Payment Details</b> in your bank account → <b>Done</b>.</p>
      <div class="phone-images-row">
        <img class="phone-image" src="/images/blog/2025-10-14-bitcoin-2/relai-1.jpg"></img>
        <img class="phone-image" src="/images/blog/2025-10-14-bitcoin-2/relai-1.jpg"></img>
        <img class="phone-image" src="/images/blog/2025-10-14-bitcoin-2/relai-1.jpg"></img>
      </div>
    <p>Relai will not take the money directly from your account even if you configure a periodic purchase. You need to create the periodic purchase in your bank account with the information in the Payment Details section using your bank account.</p>
    </div>
  </div>
</div>
...
<b>2. Confirm your private wallet</b> 

<p>Iin case it's needed go to sing in in bluewallet and so on and so on. Add <b>three images</b> here too, since this step is the same whether for 21Bitcoin as for Relai.</p>
<p>Or maybe this could be the step 3 instead, and add a '*' or refernce thing, for example in this line: <b>'Verify ownership with 2FA signature'</b>, so that people now that when they are reading that part, they have to visit this  confirm your private wallet part.</p>

<b>3. Configure automatic transfers</b> 
...
<div class="exchange-toggle-container">
  ...
  <div class="exchange-images">
    ...
    <div class="image-set" data-exchange="relai">
      <ul>
        <li>Open <b>Relai</b></li>
        <li>Go to <b>Withdraw</b> or <b>Auto-withdraw</b> (in Settings/Profile; labels may vary)</li>
        <li><b>Add your external wallet address</b> (paste the BlueWallet address)</li>
        <li>If available, <b>enable auto-withdraw</b> and set a <b>threshold</b></li>
        <li>Otherwise, you can <b>withdraw manually</b> after each purchase</li>
      </ul>
      <div class="phone-images-row">
        <img class="phone-image" src="/images/blog/2025-10-14-bitcoin-2/relai-1.jpg"></img>
        <img class="phone-image" src="/images/blog/2025-10-14-bitcoin-2/relai-1.jpg"></img>
...
> <p>* In 21Bitcoin and Relai, you have two automatic transfer options:</p>
> 
