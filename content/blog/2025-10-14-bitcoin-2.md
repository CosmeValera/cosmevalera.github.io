...
```js
Another blog-post for the continuation (This is actually trying to do too much, it's better ot split hot wallet into one post, and cold wallet into another post. It's nice to explain the difference tho):
